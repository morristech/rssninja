...
public class RateMeMaybeFragment extends DialogFragment implements OnClickListener, OnCancelListener {
	...
	public void setData(int customIcon, String title, String message, String positiveBtn, String neutralBtn,
			String negativeBtn, RMMFragInterface myInterface) {
