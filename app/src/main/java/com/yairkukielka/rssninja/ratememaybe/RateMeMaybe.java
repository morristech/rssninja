package com.yairkukielka.rssninja.ratememaybe;
...
public class RateMeMaybe implements RateMeMaybeFragment.RMMFragInterface {
	...
	/**
	 * Invite to rate the app
	 */
	public static void rateApp(FragmentActivity fragmentActivity) {
//		RateMeMaybe.resetData(this);
		RateMeMaybe rmm = new RateMeMaybe(fragmentActivity);
		rmm.setPromptMinimums(10, 14, 10, 30);
		rmm.setDialogMessage(fragmentActivity.getResources().getString(R.string.rate_app_message));
		rmm.setDialogTitle(fragmentActivity.getResources().getString(R.string.rate_app));
		rmm.setNegativeBtn(fragmentActivity.getResources().getString(R.string.rate_app_negative));
		rmm.setNeutralBtn(fragmentActivity.getResources().getString(R.string.rate_app_neutral));
		rmm.setPositiveBtn(fragmentActivity.getResources().getString(R.string.rate_app_positive));
		rmm.run();
	}
